  ...
  useEffect(() => {
    const fetchFriendRequests = async () => {
      ...
      try {
        ...
        setIncomingRequests(response.incomingRequest || []);
        setAcceptedRequests(response.acceptedRequest || []);
      } catch (error) {
  ...
  const handleAccept = async (requestId: string) => {
    ...
    try {
     ...
     console.log("Accepted Friend Request:", response);
      ...
      const acceptedReq = incomingRequests.find((req) => req._id === requestId);
       console.log("Accepted Friend Request:", acceptedReq);
